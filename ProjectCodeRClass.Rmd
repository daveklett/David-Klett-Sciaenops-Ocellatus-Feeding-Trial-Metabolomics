Load datasets
```{r}
individuals <- read.csv(file = "Individuals.csv", header = TRUE, sep = ",")
diets <- read.csv(file = "Diets.csv", header = TRUE, sep = ",")
dryfishweights <- read.csv(file = "Fish Weights.csv", header = TRUE, sep = ",")
