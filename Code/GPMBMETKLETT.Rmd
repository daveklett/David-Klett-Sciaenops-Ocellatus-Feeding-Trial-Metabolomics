...
mean(individuals$wt[individuals$diet == 1])
mean(individuals$wt[individuals$diet == 2])
mean(individuals$wt[individuals$diet == 3])
mean(individuals$wt[individuals$diet == 4])
mean(individuals$wt[individuals$diet == 5])
mean(individuals$wt[individuals$diet == 6])
mean(individuals$wt[individuals$diet == 7])
mean(individuals$wt[individuals$diet == 8])
...
boxplot(individuals$wt ~ individuals$diet, xlab = "Diet", ylab = "Fish Weight (g)", main = "Average Fish Weight Across Diets")
boxplot(individuals$liverwt ~ individuals$diet, xlab = "Diet", ylab = "Liver Weight (g)", main = "Average Fish Liver Weight Across Diets")
boxplot(individuals$percentviscera ~ individuals$diet, xlab = "Diet", ylab = "Percent Viscera (%)", main = "Average Fish Percent Viscera Across Diets")
...
boxplot(individuals$wtdiff ~ individuals$diet, xlab = "Diet", ylab = "Weight Difference (g)", main = "Average Fish Total Weight - Eviscerated Weight Across Diets")
